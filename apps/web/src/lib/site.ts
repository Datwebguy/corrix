...
export const SITE = {
  ...
  description:
    "Corrix is the paid verification layer for the agent economy. Hire it to check claims and outputs, receive a structured receipt with a content hash, and settle in USDC on chain via CROO CAP.",
